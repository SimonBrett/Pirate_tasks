...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Daniel\\Documents\\GitHub\\Pirate_tasks\\anim_test_lastrun.py',
...
outer_rect = visual.Rect(
    ...
    width=(0.02, 0.38)[0], height=(0.02, 0.38)[1],
    ori=0, pos=(0, -0.07),
